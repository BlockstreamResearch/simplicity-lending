...
#[cfg(test)]
mod tests {
    use contracts::asset_auth::build_arguments::AssetAuthArguments;
    use contracts::asset_auth::get_asset_auth_address;
    use simplicity_contracts::sdk::taproot_pubkey_gen::TaprootPubkeyGen;
    use simplicityhl_core::{Encodable, LIQUID_TESTNET_BITCOIN_ASSET, SimplicityNetwork};
    ...
    fn get_mocked_data() -> anyhow::Result<(AssetAuthArguments, TaprootPubkeyGen)> {
        let args = AssetAuthArguments::new(LIQUID_TESTNET_BITCOIN_ASSET.into_inner().0, 1, false);
