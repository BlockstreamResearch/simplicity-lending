...
pub struct ScriptAuthProgram {
    program: Program,
}
impl ScriptAuthProgram {
    pub const SOURCE: &'static str = derived_script_auth::SCRIPT_AUTH_CONTRACT_SOURCE;
...
include_simf!("simf/script_auth.simf");
