...
pub struct AssetAuthProgram {
    program: Program,
}
impl AssetAuthProgram {
    pub const SOURCE: &'static str = derived_asset_auth::ASSET_AUTH_CONTRACT_SOURCE;
...
include_simf!("simf/asset_auth.simf");
