...
pub struct IssuanceFactoryProgram {
    program: Program,
}
impl IssuanceFactoryProgram {
    pub const SOURCE: &'static str = derived_issuance_factory::ISSUANCE_FACTORY_CONTRACT_SOURCE;
    #[must_use]
...
impl AsRef<Program> for IssuanceFactoryProgram {
    fn as_ref(&self) -> &Program {
        &self.program
    }
}
impl AsMut<Program> for IssuanceFactoryProgram {
    fn as_mut(&mut self) -> &mut Program {
        &mut self.program
    }
}
include_simf!("src/artifacts/simf/issuance_factory.simf");
