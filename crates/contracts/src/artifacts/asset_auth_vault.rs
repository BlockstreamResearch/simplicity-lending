...
pub struct AssetAuthVaultProgram {
    program: Program,
}
impl AssetAuthVaultProgram {
    pub const SOURCE: &'static str = derived_asset_auth_vault::ASSET_AUTH_VAULT_CONTRACT_SOURCE;
    #[must_use]
...
impl AsRef<Program> for AssetAuthVaultProgram {
    fn as_ref(&self) -> &Program {
        &self.program
    }
}
impl AsMut<Program> for AssetAuthVaultProgram {
    fn as_mut(&mut self) -> &mut Program {
        &mut self.program
    }
}
include_simf!("src/artifacts/simf/asset_auth_vault.simf");
