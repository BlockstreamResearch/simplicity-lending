...
import { calcInterest, computeApr, netFeeBps } from '@/utils/offers'
...
export default function AcceptOfferModal({
  ...
  const txSummary = useMemo(
    () => [
      ...
      {
        label: 'APR',
        value: `${computeApr(netFeeBps(offer.interest_rate), offer.loan_expiration_height - offer.created_at_height).toFixed(2)}%`,
      },
    ],
