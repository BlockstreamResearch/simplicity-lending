...
export function isWalletAbiNetwork(value) {
    return (typeof value === "string" &&
        WALLET_ABI_NETWORKS.includes(value));
}
...
export function parseErrorInfo(value) {
...
export function parseInternalKeySource(value) {
    if (value === "bip0341") {
        return value;
    }
...
export function parseFinalizerSpec(value) {
...
export function parseWalletAbiCapabilities(value) {
...
export function parseTxCreateRequest(value) {
...
export function parseTxCreateResponse(value) {
